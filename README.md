...
This is a powerful app that allows you to replace the camera with the video you specify.  </b>  
 ...
 It can also be used to prevent all APP sneak shots. </b>    
...
**5. support all comminacation software etc.***


# Contact Me
fahimcrazylive@gmail.com

# APK Download
**Latest version : 4.4.4**  
<p align="left">
  <a href='https://opensd.google.com/store/apps/details?id=virtual.camera.app'>
    <img alt='Get it on opensd' height='90' src='https://github.com/andvipgroup/VCamera/blob/main/gp.png'/>
  </a>
</p>
